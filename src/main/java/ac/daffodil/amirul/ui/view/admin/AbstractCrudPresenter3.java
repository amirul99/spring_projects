...
public abstract class AbstractCrudPresenter3<T extends AbstractEntity, S extends CrudService<T>, V extends AbstractCrudView3<T>>
	...
	protected AbstractCrudPresenter3(NavigationManager navigationManager, S service, Class<T> entityType,
