 ...
 */
@Secured(Role.ADMIN)
public abstract class AbstractCrudView3<T extends AbstractEntity> implements Serializable, View, HasLogger {
	...
	protected abstract AbstractCrudPresenter3<T, ?, ? extends AbstractCrudView3<T>> getPresenter();
