...
public abstract class AbstractCrudPresenter4<T extends AbstractEntity, S extends CrudService<T>, V extends AbstractCrudView4<T>>
	...
	protected AbstractCrudPresenter4(NavigationManager navigationManager, S service, Class<T> entityType,
...
//		view.showInitialState();
	...
	public void addNewClicked() {
		runWithConfirmation(() -> {
			navigationManager.navigateTo(CreditEditView.class);
