...
@SpringView
public class LedgerView extends AbstractCrudView<Ledger> {

	private final LedgerPresenter presenter;

	private final LedgerViewDesign userAdminViewDesign;
	...
	@Autowired
	public LedgerView(LedgerPresenter presenter, DollarPriceConverter priceToStringConverter) {
		this.presenter = presenter;
		//this.priceToStringConverter = priceToStringConverter;
		userAdminViewDesign = new LedgerViewDesign();
	}
	...
	@Override
	public void bindFormFields(BeanValidationBinder<Ledger> binder) {
	...
	@Override
	public LedgerViewDesign getViewComponent() {
		return userAdminViewDesign;
	}

	@Override
	protected LedgerPresenter getPresenter() {
		return presenter;
	}

	@Override
	protected Grid<Ledger> getGrid() {
		return getViewComponent().list;
	}

	@Override
	protected void setGrid(Grid<Ledger> grid) {
	...
	protected Focusable getFirstFormField() {
		return getViewComponent().ledgerName;
	}
