...
public abstract class AbstractCrudView2<T extends AbstractEntity> implements Serializable, View, HasLogger {
	...
	//public static  final Grid<Debit> DGRID = DebitFrontView2;
	...
	protected abstract AbstractCrudPresenter2<T, ?, ? extends AbstractCrudView2<T>> getPresenter();
